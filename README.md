...
- **WiFi Manager bawaan**: Jika gagal terhubung ke WiFi, alat akan memancarkan Access Point
- **Pilih Musik yang tersedia**: tersedia beberapa pilihan musik, salah satunya lagu selamat ulang tahun
...
2. *Clone* repositori ini:
   ```bash
   git clone https://github.com/Muhayara/Robot-angklung.git
   ```
